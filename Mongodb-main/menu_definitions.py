...
add_menu = Menu('add', 'Please indicate what you want to add:', [
    ...
    Option("Enroll Student as PassFail", "add_student_PassFail(db)"),
    Option("Enroll Student as LetterGrade", "add_student_LetterGrade(db)"),
    Option("Exit", "pass")
])
...
delete_menu = Menu('delete', 'Please indicate what you want to delete from:', [
    ...
    Option("Enrollment", "delete_student_section(db)"),
    Option("Exit", "pass")
])
